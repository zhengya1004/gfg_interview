...
class MyTestCase(unittest.TestCase):
    def test_compute_metrics(self):
        ...
        output_data = \
            [['App install network A', 'Paid', 20, 3000, 30, 1000, '42', 0.01, 33.33, 0.02,
              'App install network'],
             ...
             ['Web channel A', 'Free', 1, 300000, 19, 4, '43', 0.0000633, 0.2105, 0.25, 'Web channel'],
             ['Web channel B', 'Paid', 3, 20, 20, 5, '43', 1, 0.25, 0.6, 'Web channel'],
             ['PR', 'Free', 33, 1, 100, 8888, '43', 100, 88.88, 0.003713, 'PR']]
        ...
        df_expected_data_paid_free = pd.DataFrame([{'Paid_Free': 'Free', 'CR': 25.284, 'ABS': 23.7138, 'CIR': 16.83},
                                                   {'Paid_Free': 'Paid', 'CR': 2.7047, 'ABS': 8.6637, 'CIR': 1.5036},
                                                   ])
